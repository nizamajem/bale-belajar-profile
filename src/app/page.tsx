...
function Hero() {
  return (
    <section className="surface-grid relative min-h-[calc(100vh-76px)] overflow-hidden">
      ...
      <div className="absolute left-1/2 top-12 h-[520px] w-[980px] -translate-x-1/2 rounded-full border border-white/80 bg-white/30 blur-3xl" />

      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-4 pb-12 pt-8 sm:px-6 md:grid-cols-[1.02fr_0.98fr] lg:px-8">
        <div className="max-w-3xl">
          <motion.div
            animate={{ opacity: 1, y: 0 }}
            className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#bfdbfe] bg-white/92 px-4 py-2 text-sm font-black text-[#1d4ed8] shadow-sm"
            initial={{ opacity: 0, y: 14 }}
          >
            <Sparkles size={17} />
            Asesmen diagnostik untuk keputusan belajar yang lebih jelas
          </motion.div>

          <motion.h1
            animate={{ opacity: 1, y: 0 }}
            className="font-heading text-4xl font-black leading-[1.03] text-[#172033] sm:text-6xl lg:text-7xl"
...
function HeroMockup() {
  ...
  return (
    <div className="float-soft relative mx-auto max-w-[590px] rounded-[8px] border border-slate-200 bg-white p-4 shadow-2xl">
      ...
      <div className="rounded-[8px] bg-[#f8fafc] p-5">
        ...
        <div className="rounded-[8px] bg-white p-3">
          <div className="mb-3 grid grid-cols-[74px_repeat(4,1fr)] gap-2 text-xs font-black text-slate-400">
            <span>Siswa</span>
            <span>Pecahan</span>
            <span>Perband.</span>
            <span>Data</span>
          ...
          <div className="grid grid-cols-[74px_repeat(4,1fr)] gap-2">
